...
W tym przykładzie wykorzystano dane o rynkowych cenach energii elektrycznej dostępne przez PSE RCE API v2 oraz dane z sensorów integracji Forecast.Solar do utworzenia wizualizacji w Grafana. Poniżej znajdują się wszystkie niezbędne integracje do zainstalowania w HA.
